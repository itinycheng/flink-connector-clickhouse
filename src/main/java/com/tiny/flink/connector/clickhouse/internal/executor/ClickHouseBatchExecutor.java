        ...
        while (i <= this.maxRetries) {
            try {
                ...
                try {
                    ...
                    throw new IOException("unable to flush; interrupted while doing another attempt", var5);
                }
        ...
        private void attemptExecuteBatch() throws IOException {
            ...
            while (i <= ClickHouseBatchExecutor.this.maxRetries) {
                try {
                    ...
                    ClickHouseBatchExecutor.LOG.error("ClickHouse executeBatch error, retry times = {}", i, var5);
